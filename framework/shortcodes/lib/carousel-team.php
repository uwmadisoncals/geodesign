...
function vntd_team_carousel($atts, $content = null) {
			...
			<div class="box-inner">
				...
				<div class="member-details">
					...
					<div class="details">
						...
						<?php if($lightbox != "no") { ?>
						<a class="member-detail-button colored-bg" data-toggle="modal" data-target="#team-<?php echo $i; ?>"></a>
						<?php } ?>
	...
	if(!function_exists('vntd_print_extra_content') && $lightbox != "no") {
		function vntd_print_extra_content() {
			...
			<div class="modal fade" id="team-<?php echo $i; ?>" tabindex="-1" role="dialog" aria-hidden="true">
				<!-- Modal Inner -->
